...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/xorg-server.pc.in \
	$(srcdir)/xserver.ent.in COPYING ChangeLog INSTALL README TODO \
...
ACLOCAL = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/missing aclocal-1.15
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/missing autoconf
AUTOHEADER = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/missing autoheader
AUTOMAKE = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/missing automake-1.15
AWK = mawk
...
DMXMODULES_CFLAGS = 
DMXMODULES_LIBS = -lXmuu -lXext -lXrender -lX11 -lXfixes -lXi -lXau
...
LIBDRM_LIBS = -ldrm
LIBOBJS =  ${LIBOBJDIR}reallocarray$U.o ${LIBOBJDIR}strlcat$U.o ${LIBOBJDIR}strlcpy$U.o
LIBS = -lm  
LIBSHA1_CFLAGS = 
LIBSHA1_LIBS = 
...
LIPO = 
LN_S = ln -s
LTLIBOBJS =  ${LIBOBJDIR}reallocarray$U.lo ${LIBOBJDIR}strlcat$U.lo ${LIBOBJDIR}strlcpy$U.lo
LT_SYS_LIBRARY_PATH = 
MAIN_LIB = $(top_builddir)/dix/libmain.la
MAKEINFO = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/missing makeinfo
MANIFEST_TOOL = :
...
SDK_REQUIRED_MODULES = xproto >= 7.0.28 randrproto >= 1.5.0 renderproto >= 0.11 xextproto >= 7.2.99.901 inputproto >= 2.3 kbproto >= 1.0.3 fontsproto >= 2.1.3 pixman-1 >= 0.27.2 videoproto resourceproto >= 1.2.0 pciaccess >= 0.12.901
SED = /bin/sed
SELINUX_CFLAGS = 
SELINUX_LIBS = 
...
XMLTO = /usr/bin/xmlto
XNESTMODULES_CFLAGS = 
XNESTMODULES_LIBS = -lXext -lX11 -lXau
XNEST_LIBS = 
XNEST_SYS_LIBS = 
...
XSERVERCFLAGS_LIBS = -lxkbfile -lpixman-1 -lXfont -lXau -lsystemd
XSERVERLIBS_CFLAGS = -I/usr/include/pixman-1 -I/usr/include/freetype2
XSERVERLIBS_LIBS = -lpixman-1 -lXfont -lXau -lsystemd
XSERVER_LIBS = $(top_builddir)/dix/libdix.la $(top_builddir)/mi/libmi.la $(top_builddir)/os/libos.la
XSERVER_SYS_LIBS = -lpixman-1 -lXfont -lXau -lsystemd  -lm  
XSHMFENCE_CFLAGS = 
...
abi_videodrv = 20.0
abi_xinput = 22.1
abs_builddir = /home/wd/xserver/xorg-server-1.18.4
abs_srcdir = /home/wd/xserver/xorg-server-1.18.4
abs_top_builddir = /home/wd/xserver/xorg-server-1.18.4
abs_top_srcdir = /home/wd/xserver/xorg-server-1.18.4
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/wd/xserver/xorg-server-1.18.4/install-sh
